...
import com.example.demo.repository.DefaultDynamoSchemaResolver;
...
public class DynamoEnhancedConfiguration {
    ...
    public DynamoEnhancedConfiguration(DynamoProperties properties) {
...
//    @Bean
//    public TableSchema defaultDynamoSchemaResolver() {
//        return new DefaultDynamoSchemaResolver().resolve(User.class, "User");
//    }
}
